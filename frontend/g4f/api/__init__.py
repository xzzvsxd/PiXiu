...
from frontend.g4f.typing import Messages
...
class Api:
    ...
    def register_routes(self):
        ...
        async def models():
            model_list = {
                model: frontend.g4f.models.ModelUtils.convert[model]
        ...
        async def model_info(model_name: str):
            try:
                model_info = frontend.g4f.models.ModelUtils.convert[model_name]
                return JSONResponse({
                    'id': model_name,
                    'object': 'model',
                    'created': 0,
